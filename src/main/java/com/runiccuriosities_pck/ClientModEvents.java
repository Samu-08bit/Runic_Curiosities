    ...
    public static class ClientForgeEvents {
        ...
        public static void onKeyInput(InputEvent.Key event) {
            ...
            if (mc.screen == null && ModKeyBindings.WARDEN_BEAM_KEY.consumeClick()) {
                PacketDistributor.sendToServer(new WardenBeamPacket());
            }
        }
        ...
        public static void onItemTooltip(ItemTooltipEvent event) {
            ...
            ResourceLocation registryName = BuiltInRegistries.ITEM.getKey(event.getItemStack().getItem());
            ...
            event.enqueueWork(() -> {
                ItemProperties.register(ModItems.NEPTUNES_HELMET.get(), ResourceLocation.fromNamespaceAndPath(RunicCuriosities.MODID, "anim_state"),
                        (itemStack, clientLevel, livingEntity, seed) -> {
                            ...
                            if (customData.contains("AnimState")) {
                                return customData.copyTag().getInt("AnimState") / 2.0F;
                            }
                            return 0.0F;
                        });
            });
